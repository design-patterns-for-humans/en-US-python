...
# Wooden door factory to return carpenter and wooden door
...
# Iron door factory to return iron door and the relevant fitting expert
...
ironDoorExpert = ironFactory.makefittingexpert()

ironDoor.getdescription()       #Output: I am an iron door
ironDoorExpert.getdescription() # Output: I can only fit iron doors
```
